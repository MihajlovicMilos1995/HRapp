...
namespace Logon.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new RegUser { UserName = model.UserName, Email = model.Email };
        ...
        public IActionResult ExternalLogin(string provider, string returnUrl = null)
        {
            ...
            var redirectUrl = Url.Action("ExternalLoginConfirmation", "Account", new { ReturnUrl = returnUrl });
        ...
        private Task<RegUser> GetCurrentUserAsync()
        {
